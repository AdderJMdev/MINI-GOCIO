        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            render={
              <Button
                variant="ghost"
                className="absolute top-2 right-2 rounded-none h-8 w-8 p-0"
                size="icon"
              />
            }
          >
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-4 -mb-4 flex flex-col-reverse gap-2 rounded-none border-t border-border bg-muted/30 p-4 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
